...
class Portfolio(models.Model):
	...
	cash = models.DecimalField(max_digits=11, decimal_places=2, help_text='Enter the amount of cash for this portfolio')
...
class Holding(models.Model):
	...
	quantity = models.IntegerField(validators=[MinValueValidator(1)], help_text='Enter the quantity for this holding')
